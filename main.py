...
from PyQt5.QtWidgets import QWidget, QApplication, QMainWindow, QFileDialog, QTableWidgetItem, QDialog
...
class ChangePost(QDialog):
    def __init__(self, post_id, db_name):
        super().__init__()
        self.post_id = post_id
        uic.loadUi('editPost.ui', self)
...
class AddPost(QDialog):
    def __init__(self, db_name):
        super().__init__()
        self.con = sqlite3.connect(db_name)
        uic.loadUi('addPost.ui', self)
        self.pushButton.clicked.connect(self.save)
